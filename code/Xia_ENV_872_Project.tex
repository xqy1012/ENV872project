...
\hypersetup{unicode=true,
            pdftitle={Does Ozone Pollution in 2018 Worsened in North Carolina?},
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Wranggling}
\NormalTok{EPA_Ozone_}\FloatTok{2017.}\NormalTok{data}\OperatorTok{$}\NormalTok{Date <-}\KeywordTok{as.Date}\NormalTok{(EPA_Ozone_}\FloatTok{2017.}\NormalTok{data}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%y"}\NormalTok{)}
\NormalTok{EPA_Ozone_}\FloatTok{2018.}\NormalTok{data}\OperatorTok{$}\NormalTok{Date <-}\KeywordTok{as.Date}\NormalTok{(EPA_Ozone_}\FloatTok{2018.}\NormalTok{data}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%y"}\NormalTok{)}

\NormalTok{EPA_Ozone_}\FloatTok{2017.}\NormalTok{data.Processed <-}\StringTok{ }\NormalTok{EPA_Ozone_}\FloatTok{2017.}\NormalTok{data }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(Date, Daily.Max.}\FloatTok{8.}\NormalTok{hour.Ozone.Concentration,}
\NormalTok{         UNITS,DAILY_AQI_VALUE,Site.Name,COUNTY,SITE_LATITUDE, SITE_LONGITUDE) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{year =} \KeywordTok{year}\NormalTok{(Date)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{month =} \KeywordTok{month}\NormalTok{(Date)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{day =} \KeywordTok{day}\NormalTok{(Date))}

\NormalTok{EPA_Ozone_}\FloatTok{2018.}\NormalTok{data.Processed <-}\StringTok{ }\NormalTok{EPA_Ozone_}\FloatTok{2018.}\NormalTok{data }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(Date, Daily.Max.}\FloatTok{8.}\NormalTok{hour.Ozone.Concentration,}
\NormalTok{         UNITS,DAILY_AQI_VALUE,Site.Name,COUNTY,SITE_LATITUDE, SITE_LONGITUDE) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{year =} \KeywordTok{year}\NormalTok{(Date)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{month =} \KeywordTok{month}\NormalTok{(Date)) }\OperatorTok{%>%}\StringTok{ }
...
\KeywordTok{write.csv}\NormalTok{(EPA_Ozone_}\FloatTok{2017.}\NormalTok{data.Processed, }\DataTypeTok{row.names =}\NormalTok{ F, }
          \DataTypeTok{file =} \StringTok{"../Processed data/EPA_Ozone_2017.data.Processed.csv"}\NormalTok{)}
\KeywordTok{write.csv}\NormalTok{(EPA_Ozone_}\FloatTok{2018.}\NormalTok{data.Processed, }\DataTypeTok{row.names =}\NormalTok{ F, }
          \DataTypeTok{file =} \StringTok{"../Processed data/EPA_Ozone_2018.data.Processed.csv"}\NormalTok{)}

\NormalTok{EPA_totalOzone.data <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(EPA_Ozone_}\FloatTok{2017.}\NormalTok{data.Processed,}
\NormalTok{                             EPA_Ozone_}\FloatTok{2018.}\NormalTok{data.Processed)}
\NormalTok{EPA_totalOzone.data}\OperatorTok{$}\NormalTok{Date <-}\KeywordTok{as.Date}\NormalTok{(EPA_totalOzone.data}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%y"}\NormalTok{)}
\NormalTok{EPA_totalOzone.data.processed <-}\StringTok{ }\NormalTok{EPA_totalOzone.data }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{year =} \KeywordTok{year}\NormalTok{(Date)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{month =} \KeywordTok{month}\NormalTok{(Date)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{day =} \KeywordTok{day}\NormalTok{(Date))}

\KeywordTok{write.csv}\NormalTok{(EPA_totalOzone.data, }\DataTypeTok{row.names =}\NormalTok{ F, }
          \DataTypeTok{file =} \StringTok{"../Processed data/EPA_totalOzone.data.processed.csv"}\NormalTok{)}

\CommentTok{#group by year/ sites}
\NormalTok{OzoneSummary_ByYearSites <-}
\StringTok{  }\NormalTok{EPA_totalOzone.data.processed }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(year, COUNTY) }\OperatorTok{%>%}\StringTok{ }
...
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{MeanOzoneAQI =} \KeywordTok{mean}\NormalTok{(DAILY_AQI_VALUE),}
            \DataTypeTok{MeanOzoneConc =}  \KeywordTok{mean}\NormalTok{(Daily.Max.}\FloatTok{8.}\NormalTok{hour.Ozone.Concentration),}
            \DataTypeTok{Units =} \StringTok{'ppm'}\NormalTok{,}
            \DataTypeTok{minOzoneAQI =} \KeywordTok{min}\NormalTok{(DAILY_AQI_VALUE),}
            \DataTypeTok{maxOzoneAQI =} \KeywordTok{max}\NormalTok{(DAILY_AQI_VALUE))}

\KeywordTok{write.csv}\NormalTok{(OzoneSummary_ByYearSites, }\DataTypeTok{row.names =}\NormalTok{ F, }
          \DataTypeTok{file =} \StringTok{"../Processed data/OzoneSummary_ByYearSites.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
